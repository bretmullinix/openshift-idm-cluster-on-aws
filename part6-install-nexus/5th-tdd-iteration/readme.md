...
This section will be used to generate a self signed certificate in the **nexus-instance/files** 
folder.  If you already have a certificate, place your certificate in the **nexus-instance/files**
folder.


### 5th TDD Iteration

**TODO:** WE MUST IMPLEMENT THE STEPS HERE AS WELL AS INSTALLING THE CERTS:
